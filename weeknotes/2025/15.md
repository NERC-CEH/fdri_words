...
## Kubecon
- Lots of AI/ML infra talk: GPU's on K8s are being very common
- Sustainability in cloud computing: Tools like kepler to measure energy consumption, Kubegreen
- Edge Computing and IOT: K8s on iot devices (K0s), NATS as an alternative protocol to MQTT
- Science and Research K8s: Talks about managing satillite imagery (~600PB/year). CERN now talk about exabytes (Petabytes were early 2000's)
