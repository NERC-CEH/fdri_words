...
The internal UI (everything FDRI related except for the new timeseries data explorer and the FDRI spatial explorer) can now be found here https://dri-ui.staging.dri.ceh.ac.uk/fdri-internal

The public UI (the new timeseries data explorer and the FDRI spatial explorer) can now be found here https://dri-ui.staging.dri.ceh.ac.uk/fdri 
