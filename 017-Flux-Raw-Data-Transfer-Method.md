...
Raw data files presently span 30 minutes, which potentially aids downloads (allowing smaller files to complete before signal issues prevent the download). But potentially could be changed.
